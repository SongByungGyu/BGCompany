...
const tasks = [
  ...
  { id: "task-thumbnail-approval", title: "유튜브 썸네일 3종 검수 요청", description: "콘텐츠 업로드 전 썸네일 후보 검수", department: "콘텐츠팀", assignedEmployeeId: "marketing-manager", status: "승인 대기", progress: 100, startedAt: new Date("2026-06-26T13:35:00+09:00"), model: "Claude Opus 4.6", cost: "0.61", currentStep: "CEO 승인 대기", recentOutput: "썸네일 3종", nextAction: "CEO 승인 필요" },
