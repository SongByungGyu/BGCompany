...
const seats: SeatPlacement[] = [
  ...
  seat("stock-seat-01", "market-analysis-room", "stock-monitor", [-1.05, 0, -5.59], "stock-desk-01"),
  seat("stock-seat-02", "market-analysis-room", "risk-trader", [0.2, 0, -5.59], "stock-desk-02"),
  seat("stock-seat-03", "market-analysis-room", "execution-trader", [1.45, 0, -5.59], "stock-desk-03"),
...
const desks: FurnitureDesk[] = [
  ...
  desk("stock-desk-01", "market-analysis-room", "stock-monitor", [-1.05, 0, -6.45]),
  desk("stock-desk-02", "market-analysis-room", "risk-trader", [0.2, 0, -6.45]),
  desk("stock-desk-03", "market-analysis-room", "execution-trader", [1.45, 0, -6.45]),
