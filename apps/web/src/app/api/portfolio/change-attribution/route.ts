...
export async function GET(request: Request) {
  ...
  return noStoreJson({
    ...
    attribution: assistant.enabled ? assistant.attribution : null,
    topContributors: assistant.enabled ? assistant.topContributors : { positive: [], negative: [] },
    message: assistant.enabled ? undefined : assistant.message,
  });
}
