...
export const STOCK_BLOG_RETRY_PHASE_LIMITS = { reference_preflight: 4, content_generation: 6, draft_assembly: 2 } as const;
export const STOCK_BLOG_MANUAL_RECOVERY_GENERATION_LIMIT = STOCK_BLOG_RETRY_PHASE_LIMITS.content_generation + 6;
