...
const STOCK_BLOG_SCHEDULE: StockBlogScheduleItem[] = [
  ...
  { contentType: "INVESTMENT_STUDY", label: "시장 연결 투자 공부", cadence: "평일 화·목 고정 + 월·수·금 이슈 시 주 1회", scheduledTimeKst: "12:10 KST", objective: "당일 코스피·미국장 이슈를 투자 원리로 설명하고, 조용한 날에는 검색형 기초 개념을 공부합니다.", primaryAudience: "시장 뉴스의 원리와 재무제표를 실제 사례로 이해하려는 투자자", recommendedRunnerMode: "hermes" },
