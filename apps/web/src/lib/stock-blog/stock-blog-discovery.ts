...
const TEMPLATE_SEARCH_INTENT_GUIDELINES: Record<StockBriefingTemplate, string[]> = {
  ...
  NEXT_WEEK_MARKET_PREVIEW: [
    "일요일 글의 1차 검색 의도는 '다음 주 증시 전망'과 '다음 주 증시 일정'입니다. 지난주 복기는 핵심 숫자 섹션에서 짧게 끝내고 본문의 70% 이상을 검증된 경제지표·실적 일정·금리 변수와 상승·하락 조건에 배정합니다.",
    "제목 후보에는 다음 주 증시 전망·경제 일정·실적·금리 중 구체적인 미래 변수를 앞쪽에 두고 토요일 글의 이번 주 수급·주도 업종 복기를 반복하지 않습니다.",
  ],
};
