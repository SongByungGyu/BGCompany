...
const TEMPLATE_SEARCH_INTENT_GUIDELINES: Record<StockBriefingTemplate, string[]> = {
  ...
  INVESTMENT_STUDY: [
    "화요일 12시 10분 글은 이번 주 CPI·PPI·FOMC·고용·실적 등 공식 일정의 발표시간과 시장 영향을 찾는 검색에 답합니다. 목요일 글은 발표 결과 뒤 주가가 왜 움직였는지 또는 배당·수급·ETF 같은 실전 질문을 해결합니다.",
    "제목 후보에는 CPI·PPI·FOMC·코스피·나스닥·외국인 수급·실적처럼 실제 검색어를 앞에 두고, 발표시간·왜·어떻게·받을 수 있을까 중 질문 하나를 붙입니다. '투자 공부' 같은 포괄어만 제목으로 사용하지 않습니다.",
  ],
